...
impl App {
    pub fn new(
        ...
        resource_manager.resources.push(Box::new(ConnectorResource {
            connector: None,
        ...
        event_manager
            ...
            .send(Event::OnAsyncEvent(tokio::spawn(async move {
                let original_connector = get_connector(&CLI_ARGS.database_uri).await;
                ...
                cloned_sender.send(Event::OnResourceEvent(
                    crate::managers::event_manager::ResourceEvent::Update(Box::new(
                        ConnectorResource {
                            connector,
                            event_sender: cloned_sender.clone(),
                        },
